 ...
 * to the client since the socket is private to this class. The ocsf.AbstractServer
...
public class ConnectionToClient extends Thread {
    ...
    * in some circumstances when Java refuses to send data that it thinks has been sent.
	 ...
	 * concrete subclasses of ocsf.AbstractServer. Based on a hash map.
	 * 
	 * @param infoType
...
// End of ocsf.ConnectionToClient class