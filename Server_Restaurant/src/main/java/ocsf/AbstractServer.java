package ocsf;// This file contains material supporting section 3.8 of the textbook:
...
/**
* The <code> ocsf.AbstractServer </code> class maintains a thread that waits
* for connection attempts from clients. When a connection attempt occurs
* it creates a new <code> ocsf.ConnectionToClient </code> instance which
...
public abstract class AbstractServer implements Runnable
{
   ...
   * thread group is a <code> ocsf.ConnectionToClient </code>.
   */
...
// CONSTRUCTOR ******************************************************
  ...
  public AbstractServer(int port)
  {
    ...
    this.clientThreadGroup =
      new ThreadGroup("ocsf.ConnectionToClient threads")
      {
...
// ACCESSING METHODS ------------------------------------------------
   ...
   * <code>ocsf.ConnectionToClient</code> instances.
   */
...
// METHODS DESIGNED TO BE OVERRIDDEN BY CONCRETE SUBCLASSES ---------
   ...
   * ocsf.ConnectionToClient thread.
...
// METHODS TO BE USED FROM WITHIN THE FRAMEWORK ONLY ----------------
   ...
   * Called by the run method of <code>ocsf.ConnectionToClient</code>
...
// End of ocsf.AbstractServer Class
